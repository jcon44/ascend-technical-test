...
>
    ...
    />
    <path 
        d="M19.784 18.906C18.2963 16.9371 16.1048 15.5485 13.593 15.131C13.1318 15.0543 12.9012 15.016 12.6515 15.1088C12.4536 15.1824 12.2376 15.3655 12.1325 15.5487C12 15.7798 12 16.0532 12 16.6V21H18.5728C19.3261 21 19.7028 21 19.9746 20.7867C20.1846 20.6219 20.3522 20.2852 20.3571 20.0183C20.3634 19.6728 20.1703 19.4172 19.784 18.906L19.784 18.906Z" 
        fill={colorOverride || "#6F6697"}
    />
    <path 
        d="M12 12C14.4853 12 16.5 9.98528 16.5 7.5C16.5 5.01472 14.4853 3 12 3V12Z" 
        fill={colorOverride || "#6F6697"}
    />
</Icon>
